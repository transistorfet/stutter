...
#define DEFAULT_IRC_FMT_CTCP_VERSION		"${fe.theme.status}%B [%@] CTCP Version received from %N (%H)"
#define DEFAULT_IRC_FMT_CTCP_VERSION_REPLY	"${fe.theme.status}%B [%@] CTCP Version reply from %N (%H) %M"
#define DEFAULT_IRC_FMT_CURRENT			"%N!%H %C %M"
#define DEFAULT_IRC_FMT_DEFAULT			"%N!%H %C %M"
#define DEFAULT_IRC_FMT_PRIVATE_ACTION		"[%@] <*> %N %M"
#define DEFAULT_IRC_FMT_PRIVATE_ACTION_SELF	"${fe.theme.bracket}[${fe.theme.nick}%@${fe.theme.bracket}]${fe.theme.message} <*> %n %M"
#define DEFAULT_IRC_FMT_PUBLIC_ACTION		"[%@] * %N %M"
#define DEFAULT_IRC_FMT_PUBLIC_ACTION_SELF	"${fe.theme.bracket}[${fe.theme.nick}%@${fe.theme.bracket}]${fe.theme.message} * %n %M"
#define DEFAULT_IRC_FMT_JOIN			"${fe.theme.status}%B [%@] Joined %P1: %N (%H)"
#define DEFAULT_IRC_FMT_KICK			"${fe.theme.status}%B [%@] %P2 was kicked from %P1 by %N (%M)"
#define DEFAULT_IRC_FMT_KICK_SELF		"${fe.theme.status}%B [%@] You were kicked from %P1 by %N (%M)"
#define DEFAULT_IRC_FMT_MODE			"${fe.theme.status}%B Mode on %P1 by %N: %P2 %P3 %P4 %P5 %P6 %P7 %P8"
//#define DEFAULT_IRC_FMT_NAMES			"$banner Users on <channel>%P3</channel>: <msg>%T</msg>"
//#define DEFAULT_IRC_FMT_NAMES			"${fe.theme.status}$banner Users on %P3: %M"
#define DEFAULT_IRC_FMT_NAMES			"${fe.theme.status}%B Users on %P3: %M"
#define DEFAULT_IRC_FMT_NICK			"${fe.theme.status}%B [%@] nick: %N -> %P1"
#define DEFAULT_IRC_FMT_NOTICE			"%B [%@] -%N- %M"
#define DEFAULT_IRC_FMT_NOTICE_SELF		"%B ${fe.theme.bracket}[${fe.theme.nick}%@${fe.theme.bracket}]${fe.theme.message} -%n- %M"
#define DEFAULT_IRC_FMT_PART			"${fe.theme.status}%B [%@] Leaving %P1: %N (%M)"
#define DEFAULT_IRC_FMT_PING			"${fe.theme.status}%B [%@] Ping received from %N (%H)"
#define DEFAULT_IRC_FMT_PING_REPLY		"${fe.theme.status}%B [%@] Ping reply from %N (%M)"
#define DEFAULT_IRC_FMT_PRIVATE_MSG		"-[%@ %N]- %M"
#define DEFAULT_IRC_FMT_PRIVATE_MSG_SELF	"-${fe.theme.bracket}[${fe.theme.nick}%@ %n -> %P1${fe.theme.bracket}]${fe.theme.message}- %M"
#define DEFAULT_IRC_FMT_PUBLIC_MSG		"[%@ %N] %M"
#define DEFAULT_IRC_FMT_PUBLIC_MSG_SELF		"${fe.theme.bracket}[${fe.theme.nick}%@ %n${fe.theme.bracket}]${fe.theme.message} %M"
#define DEFAULT_IRC_FMT_QUIT			"${fe.theme.status}%B [%@] Quit: %N (%M)"
#define DEFAULT_IRC_FMT_TOPIC			"${fe.theme.topic}%B Topic Set by %N To: %M"
#define DEFAULT_IRC_FMT_WHOISUSER		"${fe.theme.status}%B [Whois %P2] Realname : %M"
#define DEFAULT_IRC_FMT_WHOISSERVER		"${fe.theme.status}%B [Whois %P2] Server : %P3 (%M)"
#define DEFAULT_IRC_FMT_WHOISOPERATOR		"${fe.theme.status}%B %P2 %M"
#define DEFAULT_IRC_FMT_WHOISIDLE		"${fe.theme.status}%B [Whois %P2] %P3 %M"
#define DEFAULT_IRC_FMT_WHOISCHANNELS		"${fe.theme.status}%B [Whois %P2] Channels : %M"
#define DEFAULT_IRC_FMT_WHOISSPECIAL		"${fe.theme.status}%B %M"
#define DEFAULT_IRC_FMT_WHOWASUSER		"${fe.theme.status}%B [Whowas %P2 (%P3@%P4)] Realname : %M"
#define DEFAULT_IRC_FMT_NOSUCHNICK		"${fe.theme.error}%B %P2 %M"
